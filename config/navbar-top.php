    ...
    <div class="main-wrapper">
        <div class="nav-header bg-white shadow-xs border-0">
            <div class="nav-top">
                ...
                <a href="video.php" class="mob-menu me-2"><i class="feather-video text-grey-900 font-sm btn-round-md bg-greylight"></i></a>
            ...
            <form action="#" class="float-left header-search">
                <div class="form-group mb-0 icon-input">
                    ...
                    <input type="text" placeholder="Tìm kiếm trên Facebook" class="bg-grey border-0 lh-32 pt-2 pb-2 ps-5 pe-3 font-xssss fw-500 rounded-xl w350 theme-dark-bg">
                </div>
            </form>
