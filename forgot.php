        ...
        <div class="row">
            ...
            <div class="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-3 overflow-hidden">
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    ...
                    <svg class="banner-register" xmlns="http://www.w3.org/2000/svg" width="70%" height="360" fill="none" viewBox="0 0 1090 360">
                        ...
                        <h2 class="fw-700 display1-size display2-md-size mb-4">Quên mật khẩu</h2>                        
                        <form>
                            
                            
                            <div class="form-group icon-input mb-3">
                                <input type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Nhập Email hoặc số điện thoại đăng ký">
                                <i class="font-sm ti-email text-grey-500 pe-0"></i>
                            </div>
                            <div class="form-group icon-input mb-1">
                                <input type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Nhập mật khẩu mới">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                            </div>
                            <div class="form-check text-left mb-3">
                                <input type="checkbox" class="form-check-input mt-2" id="exampleCheck4">
                                <label class="form-check-label font-xsss text-grey-500" for="exampleCheck4">Chấp nhận Điều khoản và Điều kiện</label>
                                <!-- <a href="#" class="fw-600 font-xsss text-grey-700 mt-1 float-right">Forgot your Password?</a> -->
                            </div>
                        </form>
                         
                        <div class="col-sm-12 p-0 text-left">
                            <div class="form-group mb-1"><a href="login.html" class="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0 ">Nhận mã xác thực</a></div>
