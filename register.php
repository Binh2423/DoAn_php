            ...
            <div class="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-3 overflow-hidden">
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <h2 class="fw-700 display1-size display2-md-size mb-4" style="text-align: center;">Tạo tài khoản mới</h2>
                        <form>
                            ...
                            <div class="form-check text-left mb-3">
                                ...
                                <label class="form-check-label font-xsss text-grey-500" for="exampleCheck2">Chấp nhận Điều khoản và Điều kiện</label>
                        ...
                        <div class="col-sm-12 p-0 text-left">
                            ...
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Đã có tài khoản <a href="login.php" class="fw-700 ms-1">Đăng nhập tại đây</a></h6>
                        </div>
