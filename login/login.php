                    ...
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group icon-input mb-3">
                                ...
                                <input type="text" name="email" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Email hoặc số điện thoại" required>
                            </div>
                            ...
                            <div class="form-check text-left mb-3">
                                ...
                                <label class="form-check-label font-xsss text-grey-500" for="remember">Ghi nhớ tài khoản</label>
