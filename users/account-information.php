            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
                        <div class="card-body p-0 rounded-xxl overflow-hidden m-3"><img src="images/bg_profile_fb.png" alt="image"></div>
                        <div class="card-body p-0 position-relative">
                            <figure class="avatar position-absolute w100 z-index-1" style="top:-40px; left: 30px;"><img src="images/avatar_fb.jpg" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <h4 class="fw-700 font-sm mt-2 mb-lg-5 mb-4 pl-15">TRƯƠNG NGỌC PHÚ <span class="fw-500 font-xssss text-grey-500 mt-1 mb-3 d-block">14K người theo dõi • 438 đang theo dõi
                                </span></h4>
                            <div class="d-flex align-items-center justify-content-center position-absolute-md right-15 top-0 me-2">
                                <a href="account.php" class="d-none d-lg-block bg-success p-3 z-index-1 rounded-3 text-white font-xsssss text-uppercase fw-700 ls-3"><i class="feather-edit font-md"></i> Chỉnh sửa trang cá nhân</a>
                                ...
                                <!-- IF ELSE CHỖ NÀY ĐỂ CHECK PHẢI TRANG CÁ NHÂN KO (NẾU KO THÌ SẼ HIỂN THỊ ĐOẠN CODE BÊN DƯỚI) -->
                                <!-- <div class="d-flex align-items-center justify-content-center position-absolute-md right-15 top-0 me-2">
                        ...
                        <div class="card-body d-block w-100 shadow-none mb-0 p-0 border-top-xs">
                            <ul class="nav nav-tabs h55 d-flex product-info-tab border-bottom-0 ps-4" id="pills-tab" role="tablist">
                                <li class="active list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block active" href="#navtabs1" data-toggle="tab">Giới thiệu</a></li>
                                <li class="list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navtabs2" data-toggle="tab">Bạn bè</a></li>
                                <li class="list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navtabs3" data-toggle="tab">Bài viết</a></li>
                                ...
                                <li class="list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navtabs3" data-toggle="tab">Nhóm</a></li>
                                <li class="list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navtabs1" data-toggle="tab">Sự kiện</a></li>
                                <li class="list-inline-item me-5"><a class="fw-700 me-sm-5 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navtabs7" data-toggle="tab">Ảnh</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-8 col-xxl-9 col-lg-8">
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3 mt-3">
                        ...
                        <div class="card-body p-0 mt-3 position-relative">
                            ...
                            <textarea name="message" class="h100 bor-0 w-100 rounded-xxl p-2 ps-5 font-xssss text-grey-500 fw-500 border-light-md theme-dark-bg" cols="30" rows="10" placeholder="Bạn đang nghĩ gì?"></textarea>
                        </div>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                        <div class="card-body p-0 d-flex">
                            ...
                            <h4 class="fw-700 text-grey-900 font-xssss mt-1">TRƯƠNG NGỌC PHÚ. <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">3 hour ago</span></h4>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                        <div class="card-body p-0 d-flex">
                            <figure class="avatar me-3"><img src="images/avatar_fb.jpg" alt="image" class="shadow-sm rounded-circle w45"></figure>
                            <h4 class="fw-700 text-grey-900 font-xssss mt-1">TRƯƠNG NGỌC PHÚ. <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">2 hour ago</span></h4>
